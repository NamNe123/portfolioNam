...
const sprites = "/assets/icons-BcLQRtbC.svg";
    ...
    "svg",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("defs", { children: /* @__PURE__ */ jsxs("clipPath", { id: clipId, children: [
          /* @__PURE__ */ jsx("path", { d: "M0 0h6v12h8V0h6v29h-6V17H6v12H0V0Z" }),
          /* @__PURE__ */ jsx("path", { d: "M22 0h6l8 18V0h6v29h-6l-8-18v18h-6V0Z" })
        ] }) }),
...
const name$2 = "Nguyễn Phạm Hải Nam";
...
const navbar = "_navbar_orjth_2";
const logo = "_logo_orjth_27";
const nav = "_nav_orjth_2";
const navList = "_navList_orjth_53";
const navLink = "_navLink_orjth_62";
const navIcons$1 = "_navIcons_orjth_105";
const navIconLink$1 = "_navIconLink_orjth_129";
const navIcon$1 = "_navIcon_orjth_105";
const mobileNav$1 = "_mobileNav_orjth_150";
const mobileNavLink = "_mobileNavLink_orjth_180";
const styles$m = {
  navbar,
  logo,
  nav,
...
const Footer = ({ className }) => /* @__PURE__ */ jsx("footer", { className: classes(styles$i.footer, className), children: /* @__PURE__ */ jsxs(Text, { size: "s", align: "center", children: [
  ...
  /* @__PURE__ */ jsx(Link, { secondary: true, className: styles$i.link, href: "/humans.txt", target: "_self", children: "Được tạo ra bởi chính tôi" })
] }) });
...
const Carousel = lazy(
  () => import("./index-DItto7Tp.js").then((module) => ({ default: module.Carousel }))
);
const Armor = lazy(() => import("./armor-7ztheVuw.js").then((module) => ({ default: module.Armor })));
...
const sprTextureLarge = "/assets/spr-lesson-builder-dark-DaUgGLxo.jpg";
const sprTexturePlaceholder = "/assets/spr-lesson-builder-dark-placeholder-BYjrS8rr.jpg";
const sprTexture = "/assets/spr-lesson-builder-dark-DaUgGLxo.jpg";
const imageSprLessonBuilderLightLarge = "/assets/spr-lesson-builder-dark-DaUgGLxo.jpg";
const imageSprLessonBuilderLightPlaceholder = "/assets/spr-lesson-builder-light-placeholder-Dq8oUDzc.jpg";
const imageSprLessonBuilderLight = "/assets/spr-lesson-builder-dark-DaUgGLxo.jpg";
...
const Earth = lazy(() => import("./earth-CdW2ATgE.js").then((module) => ({ default: module.Earth })));
const EarthSection = lazy(
  () => import("./earth-CdW2ATgE.js").then((module) => ({ default: module.EarthSection }))
);
const title$5 = "Hệ thống thông tin hỗ trợ và phát triển vùng đồng bào dân tộc thiểu số Ban dân tộc tỉnh Đắk Nông (01/2024 - 05/2024)";
const description$3 = "Trang web Hệ thống thông tin hỗ trợ và phát triển vùng đồng bào dân tộc thiểu số Ban Dân tộc tỉnh Đắk Nông đóng vai trò quảng bá và thúc đẩy phát triển toàn diện trên các lĩnh vực Kinh tế - Xã hội, Văn hóa - Du lịch, Chính sách - Thủ tục, đồng thời hỗ trợ quản lý số lượng và phân bố các dân tộc theo từng khu vực. Hệ thống giúp tối ưu hóa quản lý chính sách hỗ trợ, tạo kênh thông tin minh bạch và hiệu quả, góp phần nâng cao chất lượng cuộc sống và kết nối cộng đồng dân tộc thiểu số.";
const roles$1 = [
  "Thu thập và phân tích ý kiến khách hàng.",
    ...
    /* @__PURE__ */ jsxs(ProjectContainer, { children: [
      ...
      /* @__PURE__ */ jsx(
        ProjectHeader,
        {
          ...
          url: "https://htcsdldt.daknong.gov.vn/",
          roles: roles$1
        }
      ),
      ...
      /* @__PURE__ */ jsx(ProjectSection, { children: /* @__PURE__ */ jsxs(ProjectTextRow, { children: [
        /* @__PURE__ */ jsx(ProjectSectionHeading, { children: "Thu thập và phân tích ý kiến khách hàng." }),
        /* @__PURE__ */ jsx(ProjectSectionText, { children: "Vào tháng 01/2024, dự án Hệ thống thông tin hỗ trợ và phát triển vùng đồng bào dân tộc thiểu số Ban Dân tộc tỉnh Đắk Nông bắt đầu triển khai giai đoạn khảo sát và thu thập ý kiến khách hàng nhằm nâng cao hiệu quả quản lý và hỗ trợ cộng đồng dân tộc thiểu số." }),
        /* @__PURE__ */ jsx(ProjectSectionText, { children: "Công việc thực hiện:" }),
        /* @__PURE__ */ jsx("text", { children: "- Tiến hành khảo sát thực tế tại các huyện." }),
        /* @__PURE__ */ jsx("text", { children: "- Thu thập phản hồi từ các hộ dân, chính quyền địa phương và các đơn vị liên quan." }),
        /* @__PURE__ */ jsx("text", { children: "- Phân tích dữ liệu để đánh giá nhu cầu và mức độ phù hợp của các chính sách hỗ trợ." }),
        /* @__PURE__ */ jsx("text", { children: "- Đề xuất cải tiến hệ thống dựa trên phản hồi của người dùng, giúp tối ưu hóa quy trình quản lý và triển khai chính sách." })
      ] }) }),
      /* @__PURE__ */ jsx(ProjectSection, { light: isDark, children: /* @__PURE__ */ jsx(ProjectSectionContent, { children: /* @__PURE__ */ jsx(ProjectTextRow, { children: /* @__PURE__ */ jsxs(
        SegmentedControl,
        {
        ...
        ProjectSection,
        {
          ...
          children: /* @__PURE__ */ jsxs(ProjectSectionColumns, { width: "full", children: [
            /* @__PURE__ */ jsx(ProjectSectionContent, { width: "full", children: /* @__PURE__ */ jsxs(ProjectTextRow, { width: "s", children: [
              /* @__PURE__ */ jsx(ProjectSectionHeading, { children: "Front-End Development" }),
              /* @__PURE__ */ jsxs(ProjectSectionText, { children: [
                /* @__PURE__ */ jsx("text", { children: "- Phát triển giao diện người dùng với React.js, tối ưu hóa trải nghiệm sử dụng cho cán bộ quản lý và người dân." }),
                /* @__PURE__ */ jsx("text", { children: "- Xây dựng các trang thông tin về Kinh tế - Xã hội, Văn hóa - Du lịch, Chính sách - Thủ tục và quản lý số lượng các dân tộc theo khu vực." }),
                /* @__PURE__ */ jsx("text", { children: "- Thiết kế giao diện riêng cho từng huyện, đảm bảo thông tin hiển thị đầy đủ, trực quan và dễ dàng sử dụng." }),
                /* @__PURE__ */ jsx("text", { children: "- Xây dựng hệ thống báo cáo trực quan, sử dụng biểu đồ cột, biểu đồ đường và biểu đồ tròn để hiển thị số liệu thống kê theo ngày, tháng, năm." }),
                /* @__PURE__ */ jsx("text", { children: "- Kết nối API với hệ thống Backend để hiển thị dữ liệu chính xác và đồng bộ." })
              ] })
            ] }) }),
            /* @__PURE__ */ jsx(
              Image$1,
          ...
          children: [
            /* @__PURE__ */ jsx(
              EarthSection,
              {
                ...
                children: /* @__PURE__ */ jsx(ProjectSection, { children: /* @__PURE__ */ jsx(ProjectSectionContent, { children: /* @__PURE__ */ jsxs(ProjectTextRow, { center: true, children: [
                  /* @__PURE__ */ jsx(ProjectSectionHeading, { children: "Back-End Development" }),
                  /* @__PURE__ */ jsx(ProjectSectionText, { children: "Xây dựng hệ thống quản lý người dùng với Role-Based Authentication, mã hóa dữ liệu để bảo vệ thông tin người dùng, phân quyền truy cập theo cán bộ quản lý, chính quyền địa phương và người dân, đảm bảo tính bảo mật và an toàn cho hệ thống." })
                ] }) }) })
              }
            ),
            /* @__PURE__ */ jsx(
            ...
            /* @__PURE__ */ jsx(
              EarthSection,
              {
                ...
                children: /* @__PURE__ */ jsx(ProjectSection, { children: /* @__PURE__ */ jsx(ProjectSectionContent, { width: "xl", children: /* @__PURE__ */ jsxs(ProjectTextRow, { justify: "end", width: "s", children: [
                  /* @__PURE__ */ jsx(ProjectSectionHeading, { level: 4, as: "h3", children: "Back-End Development" }),
                  /* @__PURE__ */ jsx(ProjectSectionText, { children: "Triển khai hệ thống báo cáo động, hỗ trợ lọc và truy vấn dữ liệu theo ngày, tháng, năm, giúp theo dõi tình hình dân số, chính sách hỗ trợ và phát triển kinh tế - xã hội" })
                ] }) }) })
              }
            ),
            /* @__PURE__ */ jsx(
              EarthSection,
              {
                ...
                children: /* @__PURE__ */ jsx(ProjectSection, { children: /* @__PURE__ */ jsx(ProjectSectionContent, { width: "xl", children: /* @__PURE__ */ jsxs(ProjectTextRow, { justify: "start", width: "s", children: [
                  /* @__PURE__ */ jsx(ProjectSectionHeading, { level: 4, as: "h3", children: "Back-End Development" }),
                  /* @__PURE__ */ jsx(ProjectSectionText, { children: "Hỗ trợ xuất báo cáo đa định dạng (Excel, Word, PDF), phục vụ công tác quản lý và lập kế hoạch chính sách." })
                ] }) }) })
              }
            ),
            /* @__PURE__ */ jsx(
            ...
            /* @__PURE__ */ jsx(
              EarthSection,
              {
                ...
                labels: ["View", "Controller", "Model"],
                children: /* @__PURE__ */ jsx(ProjectSection, { children: /* @__PURE__ */ jsx(ProjectSectionContent, { width: "xl", children: /* @__PURE__ */ jsxs(ProjectTextRow, { justify: "end", width: "s", children: [
                  /* @__PURE__ */ jsx(ProjectSectionHeading, { level: 4, as: "h3", children: "Back-End Development" }),
                  /* @__PURE__ */ jsx(ProjectSectionText, { children: "Sử dụng mô hình MVC (Model-View-Controller) để quản lý luồng dữ liệu một cách rõ ràng và hiệu quả:" }),
                  /* @__PURE__ */ jsx("text", { children: "- Model xử lý dữ liệu, tương tác với cơ sở dữ liệu." }),
                  /* @__PURE__ */ jsx("text", { children: "- Controller nhận yêu cầu từ người dùng, gọi Model để lấy dữ liệu và gửi nó đến View." }),
                  /* @__PURE__ */ jsx("text", { children: "- View hiển thị dữ liệu trên giao diện cho người dùng." }),
                  /* @__PURE__ */ jsx(ProjectSectionText, { children: "Cách tổ chức này giúp mã nguồn dễ bảo trì, mở rộng và cải thiện hiệu suất ứng dụng. 🚀" })
                ] }) }) })
              }
            ),
            /* @__PURE__ */ jsx(
      ...
      /* @__PURE__ */ jsx(ProjectSection, { children: /* @__PURE__ */ jsx(ProjectSectionContent, { children: /* @__PURE__ */ jsxs(ProjectTextRow, { center: true, centerMobile: true, noMargin: true, children: [
        /* @__PURE__ */ jsx(ProjectSectionHeading, { children: "Kết quả dự án" }),
        /* @__PURE__ */ jsx(ProjectSectionText, { children: "Hệ thống đã giúp giảm 50% thời gian xử lý hồ sơ, tối ưu hóa quản lý chính sách hỗ trợ cho đồng bào dân tộc thiểu số. Giao diện thân thiện, dễ sử dụng, hỗ trợ cán bộ quản lý và người dân truy cập thông tin nhanh chóng." }),
        /* @__PURE__ */ jsx(ProjectSectionText, { children: "Các tính năng nổi bật gồm hệ thống báo cáo trực quan, tích hợp bản đồ số theo dõi dân số từng khu vực, quản lý đăng nhập phân quyền và bảo mật nâng cao (JWT, OAuth2). Hệ thống cũng hỗ trợ xuất báo cáo theo ngày, tháng, năm (Excel, PDF), góp phần nâng cao hiệu quả quản lý và hoạch định chính sách." })
      ] }) }) })
    ] }),
    /* @__PURE__ */ jsx(Footer, {})
  ] });
...
async function getPosts() {
  const modules = /* @__PURE__ */ Object.assign({ "../articles.hello-world.mdx": route3, "../articles.modern-styling-in-react.mdx": route1 });
...
const title$4 = "Phần mềm quản lý việc làm Hậu Giang (5/2023 - 8/2023)";
...
async function loader$2({ request }) {
  ...
  const module = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "../articles.hello-world.mdx": () => Promise.resolve().then(() => route3), "../articles.modern-styling-in-react.mdx": () => Promise.resolve().then(() => route1) }), `../articles.${slug}.mdx`);
  const text2 = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "../articles.hello-world.mdx": () => import("./articles.hello-world-C3lWsiOj.js"), "../articles.modern-styling-in-react.mdx": () => import("./articles.modern-styling-in-react-D1jt5bSr.js") }), `../articles.${slug}.mdx`);
  const readTime = readingTime(text2.default);
...
const navIcons = "_navIcons_esovg_3";
const navIconLink = "_navIconLink_esovg_30";
const navIcon = "_navIcon_esovg_3";
const mobileNav = "_mobileNav_esovg_52";
const stylesnav = {
  navIcons,
  navIconLink,
  navIcon,
        ...
        children: [
          /* @__PURE__ */ jsx(
            Heading,
            {
              ...
              children: /* @__PURE__ */ jsx(DecoderText, { text: "Chào hãy kết nối với tôi qua các liên kết", start: status !== "exited", delay: 300 })
            }
          ),
          /* @__PURE__ */ jsx(
            Divider,
          ...
          /* @__PURE__ */ jsxs("div", { className: stylesnav.navIcons, children: [
            /* @__PURE__ */ jsx(
              "a",
              {
                ...
                target: "_blank",
                rel: "noopener noreferrer",
                children: /* @__PURE__ */ jsx(Icon, { className: stylesnav.navIcon, icon: "facebook", size: 48 })
              },
              "facebook"
            ),
            /* @__PURE__ */ jsx(
              "a",
              {
                ...
                target: "_blank",
                rel: "noopener noreferrer",
                children: /* @__PURE__ */ jsx(Icon, { className: stylesnav.navIcon, icon: "messenger", size: 48 })
              },
              "messenger"
            )
          ] })
...
const gamestackTextureLarge = "/assets/gamestack-login-DUp87OJX.jpg";
...
const gamestackTexture = "/assets/gamestack-login-DUp87OJX.jpg";
const ecmTextureLarge = "/assets/ecm-app-B7TPErpq.jpg";
const wfTextureLarge = "/assets/wf-app-BeYMAsqe.jpg";
const wf1TextureLarge = "/assets/wf1-app-DyIiBxQY.jpg";
function subscribe() {
  return () => {
  };
}
...
const DisplacementSphere = lazy(
  () => import("./displacement-sphere-uGGkJuYz.js").then((module) => ({ default: module.DisplacementSphere }))
);
...
const profileImgLarge = "/assets/profile-6wI2Hszg.jpg";
const profileImgPlaceholder = "/assets/profile-placeholder-DOgU6wR2.jpg";
const profileImg = "/assets/profile-6wI2Hszg.jpg";
...
const ProfileText = ({ visible, titleId }) => /* @__PURE__ */ jsxs(Fragment, { children: [
  /* @__PURE__ */ jsx(Heading, { className: styles$3.title, "data-visible": visible, level: 3, id: titleId, children: /* @__PURE__ */ jsx(DecoderText, { text: "Chào bạn", start: visible, delay: 500 }) }),
  /* @__PURE__ */ jsxs(Text, { className: styles$3.description, "data-visible": visible, size: "l", as: "p", children: [
    "Xin chào, tôi là Nguyễn Phạm Hải Nam, một Nhà phát triển .NET Full-Stack tại ",
    /* @__PURE__ */ jsx(Link, { href: "https://giaiphapdientu.vn/", children: "   Công ty cổ phần tin học Tri Thức  " }),
    "ở Thành phố Hồ Chí Minh với hơn một năm kinh nghiệm, tôi chuyên phát triển các hệ thống quản lý doanh nghiệp và chính phủ bằng .NET Core, C#, React.js và SQL Server. Công việc của tôi bao gồm phát triển phần phụ trợ, tích hợp API và tối ưu hóa UI/UX. Việc quen thuộc với cả công nghệ phần giao diện người dùng và phần phụ trợ cho phép tôi xây dựng các ứng dụng liền mạch và có thể mở rộng."
  ] }),
  /* @__PURE__ */ jsxs(Text, { className: styles$3.description, "data-visible": visible, size: "l", as: "p", children: [
    "Một số dự án đáng chú ý của tôi bao gồm hệ thống quản lý việc làm, nền tảng quản trị cơ sở dữ liệu và các giải pháp chuyển đổi số cho nhiều cơ quan chính phủ khác nhau. Nếu bạn quan tâm đến các công cụ và phần mềm tôi sử dụng, hãy xem ",
    /* @__PURE__ */ jsx(Link, { href: "/uses", children: "trang sử dụng của tôi." })
  ] }),
  /* @__PURE__ */ jsx(Text, { className: styles$3.description, "data-visible": visible, size: "l", as: "p", children: "Trong thời gian rảnh rỗi, tôi thích học các ngôn ngữ lập trình mới, khám phá các ứng dụng AI và cải thiện kỹ năng giải quyết vấn đề của mình. Tôi luôn hào hứng khi nghe về các cơ hội và sự hợp tác mới, vì vậy hãy thoải mái liên hệ với tôi!" })
] });
      ...
      children: /* @__PURE__ */ jsx(Transition, { in: visible || focused, timeout: 0, children: ({ visible: visible2, nodeRef }) => /* @__PURE__ */ jsxs("div", { className: styles$3.content, ref: nodeRef, children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: styles$3.column, children: [
          /* @__PURE__ */ jsxs("div", { className: styles$3.tag, "aria-hidden": true, children: [
            ...
            /* @__PURE__ */ jsx("div", { className: styles$3.tagText, "data-visible": visible2, children: "Tôi" })
          ] }),
...
const model$1 = "_model_4rpvx_175";
...
const Model = lazy(
  () => import("./index-27_XcZDz.js").then((module) => ({ default: module.Model }))
);
function ProjectSummary({
  ...
  function renderPreview(visible) {
    return /* @__PURE__ */ jsxs("div", { className: styles$2.preview, children: [
      model2.type === "laptop" && /* @__PURE__ */ jsx(Fragment$1, { children: /* @__PURE__ */ jsxs("div", { className: styles$2.model, "data-device": "laptop", children: [
...
const home = "_home_4lglm_1";
const model = "_model_4lglm_17";
const styles$1 = {
  home,
  "custom-project-summary": "_custom-project-summary_4lglm_7",
  model
};
const links = () => {
  return [
...
const Home = () => {
  ...
  useEffect(() => {
    const sections = [intro2, projectOne, projectTwo, projectThree, projectFour, projectFive, projectSix, details2];
    ...
    /* @__PURE__ */ jsx(
      ProjectSummary,
      {
        ...
        model: {
          ...
          textures: [
            {
              srcSet: `${wfTextureLarge} 800w, ${wfTextureLarge} 1920w`,
              placeholder: ecmTexturePlaceholder
            }
          ]
        }
    ...
    /* @__PURE__ */ jsx(
      ProjectSummary,
      {
        ...
        model: {
          ...
          textures: [
            {
              srcSet: `${wf1TextureLarge} 800w, ${wf1TextureLarge} 1920w`,
              placeholder: ecmTexturePlaceholder
            }
          ]
        }
    ...
    /* @__PURE__ */ jsx(
      ProjectSummary,
      {
        ...
        model: {
          ...
          textures: [
            {
              srcSet: `${ecmTextureLarge} 800w, ${ecmTextureLarge} 1920w`,
              placeholder: ecmTexturePlaceholder
            }
          ]
        }
  ...
  return /* @__PURE__ */ jsxs(Fragment$1, { children: [
    /* @__PURE__ */ jsxs(ProjectContainer, { className: styles.uses, children: [
      ...
      /* @__PURE__ */ jsx(ProjectSection, { padding: "none", className: styles.section, children: /* @__PURE__ */ jsx(ProjectSectionContent, { children: /* @__PURE__ */ jsxs(ProjectTextRow, { width: "m", children: [
        /* @__PURE__ */ jsx(ProjectSectionHeading, { children: "Ngôn ngữ & Công nghệ phát triển" }),
        /* @__PURE__ */ jsx(ProjectSectionText, { as: "div", children: /* @__PURE__ */ jsxs(List, { children: [
          /* @__PURE__ */ jsx(ListItem, { children: "Ngôn ngữ lập trình: C#, JavaScript, TypeScript." }),
          /* @__PURE__ */ jsx(ListItem, { children: "Backend: .NET Core, ASP.NET MVC, Web API, Entity Framework, LINQ." }),
          /* @__PURE__ */ jsx(ListItem, { children: "Frontend: React.js, HTML, CSS, Bootstrap." }),
          /* @__PURE__ */ jsx(ListItem, { children: "Desktop: Windows Forms (WinForms), WPF." }),
          /* @__PURE__ */ jsx(ListItem, { children: "Cơ sở dữ liệu: SQL, T-SQL (SQL Server), PL/SQL (MySQL)." }),
          /* @__PURE__ */ jsx(ListItem, { children: "Tích hợp & API: RESTful API, GraphQL, JSON, XML." })
        ] }) })
      ] }) }) }),
      /* @__PURE__ */ jsx(ProjectSection, { padding: "none", className: styles.section, children: /* @__PURE__ */ jsx(ProjectSectionContent, { children: /* @__PURE__ */ jsxs(ProjectTextRow, { width: "m", children: [
        /* @__PURE__ */ jsx(ProjectSectionHeading, { children: "Công cụ & Môi trường làm việc" }),
        /* @__PURE__ */ jsx(ProjectSectionText, { as: "div", children: /* @__PURE__ */ jsxs(List, { children: [
          /* @__PURE__ */ jsx(ListItem, { children: "Phần mềm lập trình & Trình soạn thảo mã nguồn: Visual Studio, Visual Studio Code." }),
          /* @__PURE__ */ jsx(ListItem, { children: "Quản lý mã nguồn: Git, GitHub, GitLab." }),
          /* @__PURE__ */ jsx(ListItem, { children: "Quản lý cơ sở dữ liệu: SQL Server, MySQL." }),
          /* @__PURE__ */ jsx(ListItem, { children: "Môi trường làm việc: Windows." })
        ] }) })
      ] }) }) })
    ] }),
    /* @__PURE__ */ jsx(Footer, {})
...
const serverManifest = { "entry": { "module": "/assets/entry.client-BbSqk_uA.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-D1Eb6D8q.js"], "css": [] }, "routes": { "root": { "id": "root", "parentId": void 0, "path": "", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/assets/root-BNgjTGLN.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/components-D1Eb6D8q.js", "/assets/heading-Bchrs-MV.js", "/assets/index-BTBq8lDE.js", "/assets/visually-hidden-B0faV1x6.js", "/assets/use-spring-2Oanwiqv.js", "/assets/image-DkKB2mlE.js", "/assets/decoder-text-Bx6WN5AC.js", "/assets/error-PSkOqpZB.js", "/assets/useScrollToHash-BEnRsK5C.js", "/assets/useWindowSize-mzNSXuUf.js", "/assets/config-DAW0LLOt.js"], "css": ["/assets/heading-DbpfVEEf.css", "/assets/image-BSR16Dxz.css", "/assets/visually-hidden-DZKbrLgw.css", "/assets/decoder-text-DSqD8fOZ.css", "/assets/error-CmEnn51Q.css", "/assets/root-Ds_DD-WF.css"] }, "routes/articles.modern-styling-in-react": { "id": "routes/articles.modern-styling-in-react", "parentId": "routes/articles", "path": "modern-styling-in-react", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/articles.modern-styling-in-react-DGKst1eD.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/index-L_4ix5aQ.js"], "css": [] }, "routes/projects.volkihar-knight": { "id": "routes/projects.volkihar-knight", "parentId": "root", "path": "projects/volkihar-knight", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-BKNGKDx2.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/heading-Bchrs-MV.js", "/assets/components-D1Eb6D8q.js", "/assets/config-DAW0LLOt.js", "/assets/image-DkKB2mlE.js", "/assets/meta-D8rZH9sX.js", "/assets/useParallax-C7pygH4k.js", "/assets/project-OXLv8Smh.js"], "css": ["/assets/heading-DbpfVEEf.css", "/assets/image-BSR16Dxz.css", "/assets/meta-CUrllC_C.css", "/assets/project-D3JpM_tk.css", "/assets/route-BT5UbU5w.css"] }, "routes/articles.hello-world": { "id": "routes/articles.hello-world", "parentId": "routes/articles", "path": "hello-world", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/articles.hello-world-YblCpcvN.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/index-L_4ix5aQ.js"], "css": [] }, "routes/projects.ban-dan-toc": { "id": "routes/projects.ban-dan-toc", "parentId": "root", "path": "projects/ban-dan-toc", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-BiiXfG_z.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/heading-Bchrs-MV.js", "/assets/components-D1Eb6D8q.js", "/assets/config-DAW0LLOt.js", "/assets/image-DkKB2mlE.js", "/assets/meta-D8rZH9sX.js", "/assets/useParallax-C7pygH4k.js", "/assets/spr-lesson-builder-dark-B9AoPSv3.js", "/assets/visually-hidden-B0faV1x6.js", "/assets/project-OXLv8Smh.js"], "css": ["/assets/heading-DbpfVEEf.css", "/assets/meta-CUrllC_C.css", "/assets/image-BSR16Dxz.css", "/assets/visually-hidden-DZKbrLgw.css", "/assets/project-D3JpM_tk.css", "/assets/route-PiXNUkZG.css"] }, "routes/articles_._index": { "id": "routes/articles_._index", "parentId": "root", "path": "articles", "index": true, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-DN1yNy-1.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/heading-Bchrs-MV.js", "/assets/components-D1Eb6D8q.js", "/assets/config-DAW0LLOt.js", "/assets/index-BTBq8lDE.js", "/assets/visually-hidden-B0faV1x6.js", "/assets/use-spring-2Oanwiqv.js", "/assets/meta-D8rZH9sX.js", "/assets/image-DkKB2mlE.js", "/assets/decoder-text-Bx6WN5AC.js", "/assets/divider-Do7S2aiH.js", "/assets/useWindowSize-mzNSXuUf.js", "/assets/date-DvyCAN0s.js"], "css": ["/assets/heading-DbpfVEEf.css", "/assets/meta-CUrllC_C.css", "/assets/image-BSR16Dxz.css", "/assets/visually-hidden-DZKbrLgw.css", "/assets/decoder-text-DSqD8fOZ.css", "/assets/divider-CJ0zz9kw.css", "/assets/route-DtSYASGB.css"] }, "routes/projects.slice": { "id": "routes/projects.slice", "parentId": "root", "path": "projects/slice", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-CeU_tR4D.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/heading-Bchrs-MV.js", "/assets/components-D1Eb6D8q.js", "/assets/config-DAW0LLOt.js", "/assets/image-DkKB2mlE.js", "/assets/meta-D8rZH9sX.js", "/assets/useParallax-C7pygH4k.js", "/assets/slice-app-CKqX-vCz.js", "/assets/project-OXLv8Smh.js"], "css": ["/assets/heading-DbpfVEEf.css", "/assets/meta-CUrllC_C.css", "/assets/image-BSR16Dxz.css", "/assets/project-D3JpM_tk.css", "/assets/route-BMFIlMHl.css"] }, "routes/api.set-theme": { "id": "routes/api.set-theme", "parentId": "root", "path": "api/set-theme", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/api.set-theme-l0sNRNKZ.js?client-route=1", "imports": [], "css": [] }, "routes/articles": { "id": "routes/articles", "parentId": "root", "path": "articles", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-CJlaXL1G.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/heading-Bchrs-MV.js", "/assets/components-D1Eb6D8q.js", "/assets/config-DAW0LLOt.js", "/assets/divider-Do7S2aiH.js", "/assets/meta-D8rZH9sX.js", "/assets/image-DkKB2mlE.js", "/assets/useParallax-C7pygH4k.js", "/assets/useScrollToHash-BEnRsK5C.js", "/assets/clamp-e7DugykH.js", "/assets/date-DvyCAN0s.js", "/assets/list-wLrWvkDe.js", "/assets/index-L_4ix5aQ.js"], "css": ["/assets/heading-DbpfVEEf.css", "/assets/divider-CJ0zz9kw.css", "/assets/meta-CUrllC_C.css", "/assets/image-BSR16Dxz.css", "/assets/list-DkijDrbu.css", "/assets/route-CMd6_K8x.css"] }, "routes/contact": { "id": "routes/contact", "parentId": "root", "path": "contact", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-BLEX26hE.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/heading-Bchrs-MV.js", "/assets/index-BTBq8lDE.js", "/assets/visually-hidden-B0faV1x6.js", "/assets/use-spring-2Oanwiqv.js", "/assets/components-D1Eb6D8q.js", "/assets/config-DAW0LLOt.js", "/assets/decoder-text-Bx6WN5AC.js", "/assets/divider-Do7S2aiH.js", "/assets/meta-D8rZH9sX.js"], "css": ["/assets/heading-DbpfVEEf.css", "/assets/visually-hidden-DZKbrLgw.css", "/assets/decoder-text-DSqD8fOZ.css", "/assets/divider-CJ0zz9kw.css", "/assets/meta-CUrllC_C.css", "/assets/route-Dr4Zdul5.css"] }, "routes/home": { "id": "routes/home", "parentId": "root", "path": "home", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-2FHoABUG.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/heading-Bchrs-MV.js", "/assets/components-D1Eb6D8q.js", "/assets/config-DAW0LLOt.js", "/assets/index-BTBq8lDE.js", "/assets/visually-hidden-B0faV1x6.js", "/assets/use-spring-2Oanwiqv.js", "/assets/slice-app-CKqX-vCz.js", "/assets/spr-lesson-builder-dark-B9AoPSv3.js", "/assets/meta-D8rZH9sX.js", "/assets/decoder-text-Bx6WN5AC.js", "/assets/image-DkKB2mlE.js", "/assets/useScrollToHash-BEnRsK5C.js", "/assets/divider-Do7S2aiH.js", "/assets/useWindowSize-mzNSXuUf.js", "/assets/route-BNI1PE5r.js"], "css": ["/assets/heading-DbpfVEEf.css", "/assets/meta-CUrllC_C.css", "/assets/visually-hidden-DZKbrLgw.css", "/assets/decoder-text-DSqD8fOZ.css", "/assets/image-BSR16Dxz.css", "/assets/divider-CJ0zz9kw.css", "/assets/route-DLNzlOsj.css"] }, "routes/uses": { "id": "routes/uses", "parentId": "root", "path": "uses", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-CBoFP9sR.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/heading-Bchrs-MV.js", "/assets/components-D1Eb6D8q.js", "/assets/config-DAW0LLOt.js", "/assets/image-DkKB2mlE.js", "/assets/meta-D8rZH9sX.js", "/assets/useParallax-C7pygH4k.js", "/assets/list-wLrWvkDe.js", "/assets/project-OXLv8Smh.js"], "css": ["/assets/heading-DbpfVEEf.css", "/assets/meta-CUrllC_C.css", "/assets/list-DkijDrbu.css", "/assets/image-BSR16Dxz.css", "/assets/project-D3JpM_tk.css", "/assets/route-CrBCcXr8.css"] }, "routes/$": { "id": "routes/$", "parentId": "root", "path": "*", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/assets/_-B5xFR9Bl.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/heading-Bchrs-MV.js", "/assets/components-D1Eb6D8q.js", "/assets/index-BTBq8lDE.js", "/assets/visually-hidden-B0faV1x6.js", "/assets/use-spring-2Oanwiqv.js", "/assets/image-DkKB2mlE.js", "/assets/decoder-text-Bx6WN5AC.js", "/assets/error-PSkOqpZB.js"], "css": ["/assets/heading-DbpfVEEf.css", "/assets/image-BSR16Dxz.css", "/assets/visually-hidden-DZKbrLgw.css", "/assets/decoder-text-DSqD8fOZ.css", "/assets/error-CmEnn51Q.css"] }, "routes/home/route": { "id": "routes/home/route", "parentId": "root", "path": "/", "index": true, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-2FHoABUG.js?client-route=1", "imports": ["/assets/jsx-runtime-DexIYAB0.js", "/assets/heading-Bchrs-MV.js", "/assets/components-D1Eb6D8q.js", "/assets/config-DAW0LLOt.js", "/assets/index-BTBq8lDE.js", "/assets/visually-hidden-B0faV1x6.js", "/assets/use-spring-2Oanwiqv.js", "/assets/slice-app-CKqX-vCz.js", "/assets/spr-lesson-builder-dark-B9AoPSv3.js", "/assets/meta-D8rZH9sX.js", "/assets/decoder-text-Bx6WN5AC.js", "/assets/image-DkKB2mlE.js", "/assets/useScrollToHash-BEnRsK5C.js", "/assets/divider-Do7S2aiH.js", "/assets/useWindowSize-mzNSXuUf.js", "/assets/route-BNI1PE5r.js"], "css": ["/assets/heading-DbpfVEEf.css", "/assets/meta-CUrllC_C.css", "/assets/visually-hidden-DZKbrLgw.css", "/assets/decoder-text-DSqD8fOZ.css", "/assets/image-BSR16Dxz.css", "/assets/divider-CJ0zz9kw.css", "/assets/route-DLNzlOsj.css"] } }, "url": "/assets/manifest-dede02e0.js", "version": "dede02e0" };
...
const routes = {
  ...
  "routes/projects.ban-dan-toc": {
    id: "routes/projects.ban-dan-toc",
    parentId: "root",
    path: "projects/ban-dan-toc",
    index: void 0,
    caseSensitive: void 0,
    module: route4
  },
