...
import styles from './ban-dan-toc.module.css';
...
const title = 'Hệ thống thông tin hỗ trợ và phát triển vùng đồng bào dân tộc thiểu số Ban dân tộc tỉnh Đắk Nông (01/2024 - 05/2024)';
const description =
  ...
  return (
    <>
      <ProjectContainer>
        ...
        <ProjectSection>
          <ProjectTextRow>
            <ProjectSectionHeading>Thu thập và phân tích ý kiến khách hàng.</ProjectSectionHeading>
            <ProjectSectionText>
              Vào tháng 01/2024, dự án Hệ thống thông tin hỗ trợ và phát triển vùng đồng 
              bào dân tộc thiểu số Ban Dân tộc tỉnh Đắk Nông bắt đầu triển khai giai đoạn 
              khảo sát và thu thập ý kiến khách hàng nhằm nâng cao hiệu quả quản lý và hỗ 
              trợ cộng đồng dân tộc thiểu số.                
            </ProjectSectionText>
            <ProjectSectionText>
              Công việc thực hiện:
            </ProjectSectionText>
            <text>
              - Tiến hành khảo sát thực tế tại các huyện.
            </text>
            <text>
              - Thu thập phản hồi từ các hộ dân, chính quyền địa phương và các đơn vị liên quan.
            </text>
            <text>
              - Phân tích dữ liệu để đánh giá nhu cầu và mức độ phù hợp của các chính sách hỗ trợ.
            </text>
            <text>
              - Đề xuất cải tiến hệ thống dựa trên phản hồi của người dùng, giúp tối ưu hóa quy trình quản lý và triển khai chính sách.
            </text>
          </ProjectTextRow>
        </ProjectSection>
            ...
            <ProjectSectionColumns width="full">
              <ProjectSectionContent width="full">
                <ProjectTextRow width="s">
                  ...
                  <ProjectSectionText>
                  <text> 
                    - Phát triển giao diện người dùng với React.js, tối ưu hóa trải nghiệm sử dụng cho cán bộ quản lý và người dân.
                    </text>
                    <text> 
                    - Xây dựng các trang thông tin về Kinh tế - Xã hội, Văn hóa - Du lịch, Chính sách - Thủ tục và quản lý số lượng các dân tộc theo khu vực.
                    </text>
                    <text> 
                    - Thiết kế giao diện riêng cho từng huyện, đảm bảo thông tin hiển thị đầy đủ, trực quan và dễ dàng sử dụng.
                    </text>
                    <text> 
                    - Xây dựng hệ thống báo cáo trực quan, sử dụng biểu đồ cột, biểu đồ đường và biểu đồ tròn để hiển thị số liệu thống kê theo ngày, tháng, năm.
                    </text>
                    <text> 
                    - Kết nối API với hệ thống Backend để hiển thị dữ liệu chính xác và đồng bộ.
                    </text>
                  </ProjectSectionText> 
                </ProjectTextRow>
              </ProjectSectionContent>
                ...
                <ProjectSection>
                  <ProjectSectionContent>
                    <ProjectTextRow center>
                      ...
                      <ProjectSectionText>
                      Xây dựng hệ thống quản lý người dùng với Role-Based Authentication, 
                      mã hóa dữ liệu để bảo vệ thông tin người dùng, phân quyền truy cập theo cán bộ quản lý, 
                      chính quyền địa phương và người dân, đảm bảo tính bảo mật và an toàn cho hệ thống.
                      </ProjectSectionText>
                    </ProjectTextRow>
                  </ProjectSectionContent>
                </ProjectSection>
                ...
                <ProjectSection>
                  <ProjectSectionContent width="xl">
                    <ProjectTextRow justify="end" width="s">
                      ...
                      <ProjectSectionText>
                      Triển khai hệ thống báo cáo động, hỗ trợ lọc và truy vấn dữ liệu theo 
                      ngày, tháng, năm, giúp theo dõi tình hình dân số, chính sách hỗ trợ và 
                ...
                <ProjectSection>
                  <ProjectSectionContent width="xl">
                    <ProjectTextRow justify="start" width="s">
                      ...
                      <ProjectSectionText>
                      Hỗ trợ xuất báo cáo đa định dạng (Excel, Word, PDF), 
                      phục vụ công tác quản lý và lập kế hoạch chính sách.
                      </ProjectSectionText>
                    </ProjectTextRow>
                  </ProjectSectionContent>
                </ProjectSection>
                ...
                <ProjectSection>
                  <ProjectSectionContent width="xl">
                    <ProjectTextRow justify="end" width="s">
                      ...
                      <ProjectSectionText>
                      Sử dụng mô hình MVC (Model-View-Controller) để quản lý luồng dữ liệu một cách rõ ràng và hiệu quả:
                      </ProjectSectionText>
                      <text>
                        - Model xử lý dữ liệu, tương tác với cơ sở dữ liệu.
                      </text>
                      <text>
                        - Controller nhận yêu cầu từ người dùng, gọi Model để lấy dữ liệu và gửi nó đến View.
                      </text>
                      <text>
                        - View hiển thị dữ liệu trên giao diện cho người dùng.
                      </text>
                      <ProjectSectionText>
                        Cách tổ chức này giúp mã nguồn dễ bảo trì, mở rộng và cải thiện hiệu suất ứng dụng. 🚀
                      </ProjectSectionText>
                    </ProjectTextRow>
                  </ProjectSectionContent>
                </ProjectSection>
        ...
        <ProjectSection>
          <ProjectSectionContent>
            <ProjectTextRow center centerMobile noMargin>
              ...
              <ProjectSectionHeading>Kết quả dự án</ProjectSectionHeading>
              <ProjectSectionText>
              Hệ thống đã giúp giảm 50% thời gian xử lý hồ sơ, tối ưu hóa quản lý chính sách hỗ trợ
              cho đồng bào dân tộc thiểu số. Giao diện thân thiện, dễ sử dụng, hỗ trợ cán bộ quản lý 
              và người dân truy cập thông tin nhanh chóng.
              </ProjectSectionText>
              <ProjectSectionText>
              Các tính năng nổi bật gồm hệ thống báo cáo trực quan, tích hợp bản đồ số theo dõi dân 
              số từng khu vực, quản lý đăng nhập phân quyền và bảo mật nâng cao (JWT, OAuth2). Hệ thống 
              cũng hỗ trợ xuất báo cáo theo ngày, tháng, năm (Excel, PDF), góp phần nâng cao hiệu quả quản 
